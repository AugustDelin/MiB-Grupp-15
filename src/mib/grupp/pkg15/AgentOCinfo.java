...
public class AgentOCinfo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Vi har valt att lista alla områdeschefer istället för ");

        jLabel2.setText("en lista beroende på valt område");

        jLabel3.setText("Metod för att lista agent för valt område finns");

        jLabel4.setText("men används inte längre i systemet");

        jLabel5.setText("se kommentarer i koden under metoden");

        jLabel6.setText("listaChefAvOmråde");
